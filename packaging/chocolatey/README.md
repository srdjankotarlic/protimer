...
choco install protimer --source . --version 2.4.0 -y --debug --verbose
choco upgrade protimer --source . -y --debug --verbose
choco uninstall protimer -y --debug --verbose
choco install protimer --source . --version 2.4.0 -y --force
```
...
choco push .\protimer.2.4.0.nupkg --source https://push.chocolatey.org/
```
