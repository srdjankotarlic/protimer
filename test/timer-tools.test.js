...
test('all inline scripts parse, shared browser module is packaged', () => {
  ...
  for (const file of ['timer-tools.js', 'window-tools.js', 'tunnel-tools.js', 'scripts/smoke-layout.js', 'scripts/smoke-startup.js', 'scripts/smoke-rundown.js', 'scripts/smoke-network-ui.js'])
